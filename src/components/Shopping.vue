<template>
  <div id="shopping-cart">
    <md-button class="md-accent md-raised" @click="showList()" id="show"><p class="mycount">{{ cartCount }}</p></md-button>
    ...
    <div id="shoppingList" class="shoppingBody">
      <div class="md-layout" v-for="(item, index) in cart" :key="index">
        ...
        <div class="md-layout-item">
          <md-button class="md-primary remove-btn" @click="removeItem(index)">Remove Cart</md-button>
        </div>
      </div>
    </div>
  </div>
